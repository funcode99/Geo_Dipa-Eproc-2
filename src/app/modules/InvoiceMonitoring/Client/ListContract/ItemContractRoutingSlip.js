                ...
                <tbody>
                  ...
                  {(slipData?.support_deliverables_document_softcopy_date_out || slipData?.support_deliverables_document_softcopy_date_in) && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.support_deliverables_document_softcopy_date_out))
                          .diff(window.moment(new Date(slipData?.support_deliverables_document_softcopy_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      duration.subtract(window.moment.duration(hours, 'hours'));
                      const minutes = duration.minutes();
                      duration.subtract(window.moment.duration(minutes, 'minutes'));
                      return (
                        <td className="text-center">
                          {slipData?.support_deliverables_document_softcopy_date_in && slipData?.support_deliverables_document_softcopy_date_out ?
                            <div>
                              {days > 0 && <span>
                              ...
                              <span>
                                {minutes} <FormattedMessage id="SPAN.MINUTES" />
                              </span>
                            </div>
                            : '-'}
                        </td>
                  ...
                  {slipData?.billing_document_softcopy_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.billing_document_softcopy_date_out))
                          .diff(window.moment(new Date(slipData?.billing_document_softcopy_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      ...
                      return (
                        <td className="text-center">
                          {slipData?.billing_document_softcopy_date_in && slipData?.billing_document_softcopy_date_out ?
                            <div>
                              {days > 0 && <span>
                                {days} <FormattedMessage id="SPAN.DAYS" />
                              </span>}
                  ...
                  {slipData?.hardcopy_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.hardcopy_date_out))
                          .diff(window.moment(new Date(slipData?.hardcopy_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      ...
                      return (
                        <td className="text-center">
                          {slipData?.hardcopy_date_in && slipData?.hardcopy_date_out ?
                            <div>
                              {days > 0 && <span>
                                {days} <FormattedMessage id="SPAN.DAYS" />
                              </span>}
                  ...
                  {slipData?.park_ap_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.park_ap_date_out))
                          .diff(window.moment(new Date(slipData?.park_ap_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      ...
                      return (
                        <td className="text-center">
                          {slipData?.park_ap_date_in && slipData?.park_ap_date_out ?
                            <div>
                              {days > 0 && <span>
                                {days} <FormattedMessage id="SPAN.DAYS" />
                              </span>}
                  ...
                  {slipData?.park_byr_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.park_byr_date_out))
                          .diff(window.moment(new Date(slipData?.park_byr_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      ...
                      return (
                        <td className="text-center">
                          {slipData?.park_byr_date_in && slipData?.park_byr_date_out ?
                            <div>
                              {days > 0 && <span>
                                {days} <FormattedMessage id="SPAN.DAYS" />
                              </span>}
                  ...
                  {slipData?.bkb_document_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.bkb_document_date_out))
                          .diff(window.moment(new Date(slipData?.bkb_document_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
                      ...
                      return (
                        <td className="text-center">
                          {slipData?.bkb_document_date_in && slipData?.bkb_document_date_out ?
                            <div>
                              {days > 0 && <span>
                                {days} <FormattedMessage id="SPAN.DAYS" />
                              </span>}
                  ...
                  {slipData?.spt_date_in && <tr>
                    ...
                    {(() => {
                      var duration = window
                        .moment
                        .duration(window.moment(new Date(slipData?.spt_date_out))
                          .diff(window.moment(new Date(slipData?.spt_date_in)))
                        );
                      const days = Math.floor(duration.asDays());
                      duration.subtract(window.moment.duration(days, 'days'));
                      const hours = duration.hours();
