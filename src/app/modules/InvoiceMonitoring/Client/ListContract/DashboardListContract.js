                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          aria-expanded="false"
                          onClick={this.openFilterTable.bind(this, index)}
                        >
                          ...
                          <li style={{ width: 360, padding: 5 }}>
                            <form className="clearfix">
                              ...
                              <button
                                ...
                                onClick={this.updateValueFilter.bind(
                                  this,
                                  "loop-value-" + index
                                )}
                              >
                              ...
                              <button
                                ...
                                onClick={this.resetValueFilter.bind(
                                  this,
                                  "loop-value-" + index
                                )}
                              >
                      ...
                      {[...Array(1)].map((item, index) => {
                        return (
                          <tr key={index.toString()}>
                            <td>
                              <Link to={`/client/invoice_monitoring/` + index}>
                                SPK/07-04-2021/000
                              </Link>
                            </td>
                            <td>
                              <Link to={`/client/invoice_monitoring/` + index}>
                                Pengadaan TEST Perjanjian_1339
                              </Link>
                            </td>
                            <td>
                              <Link to={`/client/invoice_monitoring/` + index}>
