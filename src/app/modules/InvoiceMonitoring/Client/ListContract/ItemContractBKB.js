                    ...
                    <div id="bkb">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-10 border">
                                <div className="row">
                                    <div className="col">
                                    <span className="font-weight-bold">PT. Ecolab International Indonesia</span>  
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                    <span>Jl. Pahlawan, Desa Karang Asem Timur, Citeureup, Bogor 16810</span>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                    <span>Jasa Pengolahan Sistem Air Pendingin Cooling Tower PLTP Patuha Unit 1 Periode April 2020</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-md-2 d-flex justify-content-between">
                                ...
                                <input className="form-check-input pointer" type="radio" id="transfer" name="pay" />
                                </div>
                            </div>
                            <div className="col-md-5 px-0">
                                <label className="font-weight-bold pointer" htmlFor="transfer">Instruksi Pemindahan Bukuan/Transfer Bank Nomor Surat</label>
                            </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-md-2 d-flex justify-content-between">
                                ...
                                <div className="form-check">
                                <input className="form-check-input pointer" type="radio" id="giro" name="pay" />
                                </div>
                            </div>
                            <div className="col-md-4 form-group">
                                <div className="row">
                                    <label className="font-weight-bold pointer col-sm-3 px-0" htmlFor="giro">No Cek</label>
                        ...
                        <div className="row">
                            <div className="col-md border d-flex align-items-end" style={{height: 80}}>
                                <span className="mx-auto">Merry</span>
                            </div>
                            <div className="col-md border text-center" style={{height: 80}}></div>
                            <div className="col-md border text-center" style={{height: 80}}></div>
                        </div>
                        ...
                        <div className="row mt-3">
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-4 border">
                                        ...
                                        <div className="row d-flex align-items-end" style={{minHeight: 80}}>
                                            <span style={{fontSize: 8}}>Nama &amp; Tanggal</span>
                                        </div>
                                    </div>
                                    <div className="col-md-8 border">
                                        <div className="row border">
                            ...
                            <div className="col-md-5 border">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md d-flex align-items-end" style={{minHeight: 60}}>
                                    </div>
                                </div>
                            </div>
                        </div>
