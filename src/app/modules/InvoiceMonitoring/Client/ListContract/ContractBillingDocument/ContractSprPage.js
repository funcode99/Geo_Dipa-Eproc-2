            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group row">
                  ...
                  >
                    <FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.SPR_DOCUMENT.SPR_NUMBER" />
                  </label>
                ...
                <div className="form-group row">
                  <label
                    ...
                    className="col-sm-4 col-form-label"
                  >
                    <FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.SPR_DOCUMENT.ACCOUNT_NUMBER" />
                  </label>
                  <div className="col-sm-8">
                    <input
                      type="text"
                ...
                <div className="form-group row">
                  ...
                  >
                    ...
                    <span className="form-control">
                      {invoiceData ? invoiceData["file_name"] : uploadFilename}
                    </span>
                  </label>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-8">
                    <textarea
                      ...
                      className="form-control"
                      id="first"
                      defaultValue={contractData["full_data_party_1"]}
                    ></textarea>
                  </div>
                </div>
                <div className="form-group row">
                  ...
                  <div className="col-sm-8">
                    <textarea
                      ...
                      className="form-control"
                      id="second"
                      defaultValue={contractData["full_data_party_2"]}
                    ></textarea>
                  </div>
                </div>
              </div>
