      ...
      .then((response) => {
        if (!response.data.data) {
          ...
          formik.setFieldValue(
            "description",
            response.data.data ? response.data.data.description : null
          );
        }
              ...
              <div className="col-md-6">
                ...
                <div className="form-group row">
                  <label htmlFor="note" className="col-sm-4 col-form-label">
                    <FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.INVOICE_DOCUMENT.INVOICE_DESCRIPTION" />
                  </label>
                  <div className="col-sm-8">
                    <textarea
                      rows="4"
