...
import { getContractSummary, getReceipt, getFileReceipt, approveReceipt, getAllRejectedReceipt, getAllApprovedReceipt, rejectReceipt, rejectReceiptStatus } from '../../../_redux/InvoiceMonitoringCrud';
...
function ContractReceiptPage(props) {
    ...
    const approveReceiptData = () => {
        setLoading(true)
        approveReceipt(receiptData.id, { approved_by_id: user_id })
            .then((response) => {
                setToast(
    ...
    const getHistoryReceiptData = useCallback((receipt_id) => {
    ...
    return (
        <React.Fragment>
            ...
            <Dialog
                ...
                fullWidth={true}
            >
                <DialogTitle id="alert-dialog-slide-title"><FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.RECEIPT_DOCUMENT.APPROVED.APPROVE_TITLE" /></DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    >
                        <span><FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.RECEIPT_DOCUMENT.APPROVED.APPROVE_SUBMIT" /></span>
                        {loading && (
                            <span
            ...
            >
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title"><FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.RECEIPT_DOCUMENT.REJECTED.REJECT_TITLE" /></DialogTitle>
                    <DialogContent>
                    ...
                    <DialogActions>
                        ...
                        >
                            <span><FormattedMessage id="TITLE.INVOICE_MONITORING.BILLING_DOCUMENT.RECEIPT_DOCUMENT.REJECTED.REJECT_SUBMIT" /></span>
                            {loading && (
                                <span
                                    className="spinner-border spinner-border-sm ml-1"
                                    aria-hidden="true"
            ...
            <Card>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="form-group row">
                                ...
                                <div className="col-sm-8">
                                    <input type="text" className="form-control" id="numberInvoice" disabled defaultValue={receiptData?.receipt_no} />
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-8">
                                    <input type="date" className="form-control" id="dateReceipt" disabled defaultValue={receiptData?.receipt_date} />
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <div className="col-sm-8">
                                    <textarea rows="4" cols="" className="form-control" id="note" disabled defaultValue={receiptData?.description}></textarea>
                                </div>
                            </div>
                            <div className="form-group row">
                                ...
                                <label htmlFor="upload" className="input-group mb-3 col-sm-8">
                                    <span className={`form-control text-truncate ${classes.textDisabled}`}>{receiptData ? receiptData?.file_name : 'Pilih File'}</span>
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-7">
                                    <input type="text" className="form-control" id="priceTaxReceipt" defaultValue={contractData['termin_value_ppn_new']} disabled />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <CardFooter className="text-right">
                    <button type="button" onClick={() => setModalApprove(true)} disabled={isSubmit || receiptData?.state === 'REJECTED' || receiptData?.state === 'APPROVED' || receiptData === null} className="btn btn-primary mx-1"><FormattedMessage id="TITLE.ACCEPT_DOCUMENT" /></button>
                    <button type="button" onClick={() => setModalReject(true)} disabled={isSubmit || receiptData?.state === 'REJECTED' || receiptData?.state === 'APPROVED' || receiptData === null} className="btn btn-danger mx-1"><FormattedMessage id="TITLE.REJECT_DOCUMENT" /></button>
