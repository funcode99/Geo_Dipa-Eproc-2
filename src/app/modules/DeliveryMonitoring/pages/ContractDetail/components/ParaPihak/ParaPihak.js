...
const ParaPihak = () => {
  ...
  const values = React.useMemo(
    () => ({
      ...
      tgl_sk_kemenkum:contract_party?.party_1_deed_of_establishment_kemenkumham_date,
      ...
      sk_kemenkum_akhir:contract_party?.party_1_last_deed_of_amanded_kemenkumham_no,
      tgl_sk_kemenkum_akhir:contract_party?.party_1_last_deed_of_amanded_kemenkumham_date,
      ...
      tgl_sk_kemenkum_penugasan:contract_party?.party_1_autorized_kemenkumham_date,
      ...
      sk_kemenkum_2:contract_party?.party_2_deed_of_establishment_kemenkumham_no,
      tgl_sk_kemenkum_2:contract_party?.party_2_deed_of_establishment_kemenkumham_date,
      ...
      sk_kemenkum_akhir_2:contract_party?.party_2_last_deed_of_amanded_kemenkumham_no,
      tgl_sk_kemenkum_akhir_2:contract_party?.party_2_last_deed_of_amanded_kemenkumham_date,
      ...
      nama_notaris_penugasan_2:contract_party?.party_2_notary_act_autorized_name,
      ...
      tgl_sk_kemenkum_penugasan_2:contract_party?.party_2_autorized_kemenkumham_date,
