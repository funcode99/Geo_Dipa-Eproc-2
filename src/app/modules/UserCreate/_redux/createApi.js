...
export const GET_ALL_USER = `${DEV_NODE}/api/get_users/`;
export const CREATE_NEW_USER = `${DEV_NEW_NODE}/api/create_users/`;
export const CHECK_USERNAME = `${DEV_NEW_NODE}/api/check_username/`;
export const CHECK_TOKEN = `${DEV_NEW_NODE}/api/get_token_value/`;
