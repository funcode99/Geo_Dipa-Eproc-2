...
import {
  ...
  getRolesSignedGiro, updateRoles
              ...
              return (
                <tr key={index.toString()}>
                  ...
                  <td className="text-center">
                    {props.data.type !== "Signed_Giro" && props.data.type !== "Accept" && props.data.type !== "Accept_Tax" && props.data.type !== "Delivery" && <button className="btn" onClick={() => handleModal(index)}><i className="fas fa-edit text-primary pointer"></i></button>}
                  </td>
                </tr>
              )
            })
