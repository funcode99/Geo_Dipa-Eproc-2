...
import { formData1, formData2 } from "app/modules/AddendumContract/pages/ContractDetail/components/ParaPihak/fieldData"
...
const ParaPihak = () => {
  ...
  const values = React.useMemo(
    () => ({
      ...
      nama_pemberitahu  : contract_party?.party_1_employer_name,
