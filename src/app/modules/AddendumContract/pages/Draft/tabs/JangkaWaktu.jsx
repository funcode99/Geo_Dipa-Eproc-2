  ...
  const [timePeriodAddendum, setTimePeriodAddendum] = useState([
    {
      ...
      totalMonth: timePeriodAddendumCurrent?.contract_period_range_month,
      calendarDay: timePeriodAddendumCurrent?.contract_period_range_day,
      radio: timePeriodAddendumCurrent?.contract_period_type,
      prefix: "contract",
      selectableStart:
    ...
    },
    {
      ...
      totalMonth: timePeriodAddendumCurrent?.work_implement_period_month,
      calendarDay: timePeriodAddendumCurrent?.work_implement_period_day,
      radio: timePeriodAddendumCurrent?.work_period_type,
      prefix: "work",
      selectableStart:
    ...
    },
    {
      ...
      totalMonth: timePeriodAddendumCurrent?.guarantee_period_month,
      calendarDay: timePeriodAddendumCurrent?.guarantee_period_day,
      prefix: "guarantee",
    },
    {
      title: "Jangka Waktu Masa Pemeliharaan",
      ...
      totalMonth: timePeriodAddendumCurrent?.maintenance_period_month,
      calendarDay: timePeriodAddendumCurrent?.maintenance_period_day,
      prefix: "maintenance",
    },
  ]);
