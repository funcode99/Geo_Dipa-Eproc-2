...
const SupportingDocumentInput = ({ title }) => {
  return (
    <>
      {title ? (
        title?.map((item, index) => (
          <>
            ...
            <Row md={12}>
              <Col md={4}>
                <p style={{ fontWeight: 500, fontSize: 14 }}>No Dokumen</p>
                <RenderInput
                  typeInput={""}
              ...
              <Col md={3}>
                <p style={{ fontWeight: 500, fontSize: 14 }}>Tanggal Dokumen</p>
                <RenderInput
              ...
              <Col md={5}>
                <p style={{ fontWeight: 500, fontSize: 14 }}>Upload Dokumen</p>
                <RenderInput
