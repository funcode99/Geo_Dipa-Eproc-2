...
export class HtmlClassService {
  ...
  getLogo() {
    ...
    if (brandSkin === "light") {
      return toAbsoluteUrl("/media/logos/logo-eprocurement.png");
    } else {
  ...
  initTheme() {
    ...
    console.log("objectPath.get(this.config, 'header.self.theme');", objectPath.get(this.config, "header.self.theme"))
    if (!asideSelfDisplay) {
