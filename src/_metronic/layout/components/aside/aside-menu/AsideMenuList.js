  ...
  return (
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        {/*begin::1 Level*/}
        <li
          className={`menu-item ${getMenuItemActive("/client/dashboard", false)}`}
          aria-haspopup="true"
        >
        ...
        >
          <NavLink className="menu-link menu-toggle" to="/delivery_monitoring">
            ...
            <span className="menu-text"><FormattedMessage id="MENU.DELIVERY_MONITORING" /></span>
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive("/delivery_monitoring/error-v1")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/delivery_monitoring/error-v1">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.DELIVERY_MONITORING.LIST_CONTRACT_PO" /></span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/delivery_monitoring/error-v2")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/delivery_monitoring/error-v2">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.DELIVERY_MONITORING.GOOD_RECEIPT" /></span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/delivery_monitoring/error-v3")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/delivery_monitoring/error-v3">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.DELIVERY_MONITORING.SERVICE_ACCEPTANCE" /></span>
                </NavLink>
              </li>
            </ul>
          </div>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/client/invoice_monitoring/list">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl("/media/svg/icons/All/file-invoice-dollar-solid.svg")}
              />
            </span>
            <span className="menu-text"><FormattedMessage id="MENU.INVOICE_MONITORING" /></span>
            <i className="menu-arrow" />
          </NavLink>
          <div className="menu-submenu ">
            <i className="menu-arrow" />
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive("/client/invoice_monitoring")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/client/invoice_monitoring/list">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.DELIVERY_MONITORING.LIST_CONTRACT_PO" /></span>
              ...
              <li
                className={`menu-item ${getMenuItemActive("/invoice_monitoring/error-v2")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/invoice_monitoring/error-v2">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.INVOICE_MONITORING.INVOICE_DOCUMENT" /></span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/invoice_monitoring/error-v3")}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/invoice_monitoring/error-v3">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text"><FormattedMessage id="MENU.INVOICE_MONITORING.BKB_FV" /></span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/invoice_monitoring/error-v3")}`}
              ...
              >
                <NavLink className="menu-link" to="/invoice_monitoring/error-v3">
                  ...
                  <span className="menu-text"><FormattedMessage id="MENU.INVOICE_MONITORING.SPT" /></span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive("/invoice_monitoring/error-v3")}`}
              ...
              >
                <NavLink className="menu-link" to="/invoice_monitoring/error-v3">
                  ...
                  <span className="menu-text"><FormattedMessage id="MENU.INVOICE_MONITORING.TAX" /></span>
                </NavLink>
              </li>
            </ul>
          </div>
        ...
        <li
          className={`menu-item ${getMenuItemActive("/user_management", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/user_management">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/All/users-solid.svg")} />
            </span>
        ...
        {/* begin: User Management */}
        <li
          className={`menu-item ${getMenuItemActive("/master_data", false)}`}
          aria-haspopup="true"
        >
          <NavLink className="menu-link" to="/master_data">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/All/table-solid.svg")} />
            </span>
            <span className="menu-text"><FormattedMessage id="MENU.MASTER_DATA" /></span>
          </NavLink>
        </li>
        {/* end: User Management */}
        ...
        >
          <NavLink className="menu-link" to="/user-profile">
            <span className="svg-icon menu-icon">
              <SVG
                src={toAbsoluteUrl(
                  "/media/svg/icons/Communication/user-solid.svg"
                )}
              />
            </span>
